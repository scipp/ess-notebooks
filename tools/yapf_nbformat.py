#!/usr/bin/env python
# script taken from public github gist
# https://gist.githubusercontent.com/oskopek/496c0d96c79fb6a13692657b39d7c709
import nbformat
...
if __name__ == '__main__':
    ...
    parser.add_argument('file_to_format',
                        nargs='+',
                        help='The jupyter notebook file to format in place.')
    parser.add_argument(
        '--dry_run',
        action='store_true',
        help='Whether to just print if a notebook would be reformatted.')
